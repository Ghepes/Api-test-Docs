...
$product->ProductImage = $data->ProductImage;
    ...
    if($lastInsertedId!=0){
		...
		echo json_encode(array("status" => "error", "code" => 0,"message"=> "Unable to create product","document"=> ""));
    }
}
else{
    http_response_code(400);
	echo json_encode(array("status" => "error", "code" => 0,"message"=> "Unable to create product. Data is incomplete.","document"=> ""));
}
?>
