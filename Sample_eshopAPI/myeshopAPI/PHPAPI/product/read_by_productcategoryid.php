...
$product->ProductCategoryID = isset($_GET['ProductCategoryID']) ? $_GET['ProductCategoryID'] : die();

$stmt = $product->readByProductCategoryID();
$num = $stmt->rowCount();
...
if($num>0){
    ...
    $product_arr["total_count"]=$product->total_record_count();
